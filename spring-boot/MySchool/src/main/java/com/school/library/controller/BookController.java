...
public class BookController {
	...
	@PutMapping("/books/{id}")
	public ResponseEntity<Book> updateBook(@PathVariable(value = "id") Long bookId, @Valid @RequestBody Book bookData) throws ResourceNotFoundException {
		Book bookToUpdate = bookRepository.findById(bookId).orElseThrow(() -> new ResourceNotFoundException("Book not found for this id :: " + bookId));
		bookToUpdate.setBookName(bookData.getBookName());
		bookToUpdate.setLibraryId(bookData.getLibraryId());
